...
int iTorusFaces, iCylinderFaces, iCylinderFaces2, iRopeFaces, iLightFaces;
...
void AddSceneObjects(CVertexBufferObject& vboDest)
{
	...
	iTorusFaces = GenerateTorus(vboDest, 3.0f, 1.0f, 20, 20);
	iCylinderFaces = GenerateCylinder(vboDest, 1.0f, 25.0f, 20);
	iCylinderFaces2 = GenerateCylinder(vboDest, 1.0f, 6.0f, 20);
	iRopeFaces = GenerateCylinder(vboDest, 0.1f, 15.0f, 20);

	iLightFaces = GenerateCylinder(vboDest, 0.5, 0.7, 20);
}

...
float fTextureContribution2 = 0.5f;
float fTextureContributionReal = 0.5f;
// Renders whole scene.
// lpParam - Pointer to anything you want.
void RenderScene(LPVOID lpParam)
{
	...
	spMain.SetUniform("gSamplers[2]", 2);
	spMain.SetUniform("fTextureContributions[0]", 1.0f);
	spMain.SetUniform("fTextureContributions[1]", fTextureContributionReal);
	spMain.SetUniform("fTextureContributions[2]", fTextureContribution2);
	...
	tTextures[0].BindTexture(2);

	spMain.SetUniform("fTextureContributions[0]", max(0.0f, 1.0f - 2*fTextureContribution));
	spMain.SetUniform("numTextures", 3);
	...
	fTextureContribution2 = max(0.0f, fTextureContribution * 2 - 1.0f);
	fTextureContributionReal = fTextureContribution2 == 0.0f ? fTextureContribution * 2 : 1.0f - fTextureContribution2;
